...
# main# value is a global variable because we're in the global scope here
value = 10
...
change_global()
print("Back in the global scope, value has changed to:", value)
